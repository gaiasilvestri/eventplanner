...
<body>        
                <form method ="POST" action="LoginPageTestHardCode.php">
...
<div class="row">
  <div class="col-md-6">
                  ...
                  <FORM NAME="fomLogin" Method="POST" Action="<?php 
          $finish = executePlainSQL('select username from users');
 


    while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
      if ($row[0] == $_POST['loginname']){
        OCICommit($db_conn);
        return echo 'MainPage.php';
      }
    }
    OCICommit($db_conn);
    return echo 'LoginPageTestHardCode.php';
          ?>"
                          <div class="form-group">
                                    <label class=".sr-only" for="InputUsername1">Username</label>
                                    <input type="text" class="form-control" id="InputUsername1" name="loginname" placeholder="Enter Username">
                          </div>
                          <div>
        ...
        <div class="col-md-6">
                <h1> Sign Up </h1>
                <FORM NAME="fomSign" Method="POST" Action="LoginPageTestHardCode.php">
...
if ($db_conn) {
    ...
    if (array_key_exists('reset', $_POST)) {
       ...
       if (array_key_exists('insertsubmit', $_POST)) {
          ...
          echo "signin <br>";
           ...
           $tuple = array (
             ":bind1" => $_POST['loginname'],
             ":bind2" => $_POST['loginpass'],
           );
          $alltuples = array (
             $tuple
          );
          $finish = executeBoundSQL("select username from users where username = :bind1 AND upswd = :bind2", $alltuples);
          OCICommit($db_conn);
          ...
          if (array_key_exists('updatesubmit', $_POST)) {
            ...
            executeBoundSQL("update users set username=:bind2 where username=:bind1", $alltuples);
             ...
             if (array_key_exists('dostuff', $_POST)) {
                ...
                executePlainSQL("insert into users values (000000001,'rpottinger','db123db','rpottinger@live.ca','7888049292')");
                executePlainSQL("insert into users values (000000002,'giannacone','sportmaster23','greg.iannacone@gmail.com','6048924502')");
                executePlainSQL("insert into users values (000000003,'gsilvestri','longhairdontcare','gsilver@hotmail.com','7889032120')");
                executePlainSQL("insert into users values (000000004,'dpeterson','oldstewq11','danepet@gmail.com','7888889029')");
                executePlainSQL("insert into users values (000000005,'dmackenzie','tpeo2me','doug.mac@live.ca','2502342342')");
    ...
    if ($_POST && $success) {
       ...
       header("location: LoginPageTestHardCode.php");
    } else {
       // Select data...
