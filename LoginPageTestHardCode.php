...
<div class="row">
  <div class="col-md-6">
                  ...
                  <FORM NAME="fomLogin" Method="POST" Action="LoginCheck.php">
                          <div class="form-group">
                                    <label class=".sr-only" for="InputUsername1">Username</label>
                                    <input type="text" class="form-control" id="InputUsername1" name="myusername" placeholder="Enter Username">
                          </div>
                          <div>
                            <label class=".sr-only" for="InputPassword1">Password</label>
                            <input type="password" class="form-control" id="InputPassword1" name="mypassword" placeholder="Password">
                          </div>
                          <br>
                          <br>
