  ...
  <div class="col-md-6">
  		...
  		<FORM NAME="fomLogin" Method="POST" Action="mainPage.php">
  			<div class="form-group">
  				  ...
  				  <input type="email" class="form-control" id="InputUsername1" placeholder="Enter email">
  			</div>
  			<div>
	...
	<div class="col-md-6">
		<h1> Sign Up </h1>
		<FORM NAME="fomSign" Method="POST" Action="LoginPage.php">

			<div class="form-group">

			<div>
   				 <label class=".sr-only" for="SignUserId1">UserID</label>
  				  <input type="email" class="form-control" id="SignUserId1" name="userid" placeholder="Choose UID">
  			</div>

			<div>
   				 <label class=".sr-only" for="SignUsername1">Username</label>
  				  <input type="email" class="form-control" id="SignUsername1" name="username" placeholder="Choose Username">
  			</div>
  			...
  			<div>
    			...
    			<input type="email" class="form-control" id="SignPhone1" name="uphone" placeholder="Enter Phone Number">
  			</div>
...
if ($db_conn) {
    ...
    if (array_key_exists('reset', $_POST)) {
   	 ...
   	 executePlainSQL(" create table users(userid number (9,0), username varchar2(30), upswd varchar2(30), uemail varchar2(30), uphone varchar2(30), 
   	 	unique (username), primary key (userid)");
);
